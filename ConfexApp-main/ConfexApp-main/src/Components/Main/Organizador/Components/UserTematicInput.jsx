      ...
      <Controller
        ...
        rules={{
          validate: (value) => {
            ...
            if (!["e", "erc"].includes(rolSeleccionado)) return true;
            return (
              value?.length > 0 ||
              "Seleccione al menos una temática para el evaluador."
            );
          },
        }}
        render={({ field }) => (
          <>
            <Select
              ...
              placeholder="Selecciona temáticas para el evaluador"
...
export default UserTematicInput;
